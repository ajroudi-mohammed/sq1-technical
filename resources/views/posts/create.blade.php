            ...
            <div class="w-full lg:w-5/6">
                <form action="{{ route('posts.store')}}" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" method="post">
                    ...
                    <div class="mb-4 bg-white rounded-t-lg dark:bg-gray-800">
                        ...
                        <textarea id="description" name="description" rows="4" class="px-0 w-full text-sm text-gray-900 bg-gray-200 appearance-none border-2 border-gray-200 rounded pl-4" placeholder="Write a comment..." required></textarea>
                    </div>
